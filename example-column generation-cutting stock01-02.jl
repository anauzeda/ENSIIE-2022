using JuMP, LinearAlgebra, GLPK, SparseArrays, Gurobi
#lembrete: ctrl+; comenta e descomenta
...
function solve_aux_prob(
    ...
    #reduced_costs =  dual_variables + c
...
function ex_cutting_stock()
    ...
    while ncols - n <= max_gen_cols ## Generate at most max_gen_cols columns.
        ...
        ncols += 1
        patterns = hcat(patterns, new_pattern) #adicionar ao patterns um vetor new pattern
        # One new variable.
